...
**[Vantage Alpin](https://github.com/julianhilgemann/BI-Pipeline)**
End-to-end analytics pipeline for a simulated e-commerce business. Synthetic data generation (Poisson demand), dbt transformations, Kimball modeling, Power BI reporting layer.
`Python` `dbt` `DuckDB` `Power BI`
